...
const EthWallet = ({ mnemonic }) => {
    ...
    const generateWallet = async () => {
        ...
        const wallet = new Wallet(privateKey); // Generate wallet
        const publicKey = wallet.address; // Ethereum uses address as public key representation

        setCurrentIndex(currentIndex + 1);
        setWallets([...wallets, { publicKey, privateKey }]);
    };

    return (  <div className="w-full h-64 overflow-auto border p-4 bg-white shadow-md rounded-lg">
      <button
